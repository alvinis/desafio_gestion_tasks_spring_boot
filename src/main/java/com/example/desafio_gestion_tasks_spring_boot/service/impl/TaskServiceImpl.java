package com.example.desafio_gestion_tasks_spring_boot.service.impl;

import java.time.LocalDateTime;
import java.util.Collections;
import java.util.List;

import com.example.desafio_gestion_tasks_spring_boot.exceptions.TaskOperationException;
import com.example.desafio_gestion_tasks_spring_boot.exceptions.UserOperationException;
import com.example.desafio_gestion_tasks_spring_boot.mappers.TaskMapper;
import com.example.desafio_gestion_tasks_spring_boot.patterns.cor.DescriptionValidator;
import com.example.desafio_gestion_tasks_spring_boot.patterns.cor.UsernameValidator;
import com.example.desafio_gestion_tasks_spring_boot.patterns.cor.Validator;
import com.example.desafio_gestion_tasks_spring_boot.repository.TaskStatusRepository;
import org.springframework.stereotype.Service;

import com.example.desafio_gestion_tasks_spring_boot.entity.Task;
import com.example.desafio_gestion_tasks_spring_boot.entity.TaskStatus;
import com.example.desafio_gestion_tasks_spring_boot.entity.User;
import com.example.desafio_gestion_tasks_spring_boot.model.request.TaskRequestDto;
import com.example.desafio_gestion_tasks_spring_boot.model.response.ApiResponseDto;
import com.example.desafio_gestion_tasks_spring_boot.repository.TaskRepository;
import com.example.desafio_gestion_tasks_spring_boot.repository.UserRepository;
import com.example.desafio_gestion_tasks_spring_boot.service.TaskService;
